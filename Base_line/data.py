...
class Data:
    ...
    Attributes:
        ...
        tokenizer:  BertTokenizer for bert
                    Tokenizer for rnn
    """
    def __init__(self, vocab_file='', max_seq_len: int = 512, model_type: str = 'bert'):
        """
    ...
    def load_file(self, file_path='SMP-CAIL2020-train.csv', train=True) -> TensorDataset:
        """
        ...
        if self.model_type == 'bert':
            dataset = self._convert_sentence_pair_to_bert_dataset(sc_list, bc_list, label_list)
        else:  # rnn
            dataset = self._convert_sentence_pair_to_rnn_dataset(sc_list, bc_list, label_list)
        return dataset
    ...
    def _convert_sentence_pair_to_bert_dataset(self, s1_list, s2_list, label_list=None):
    ...
    def _convert_sentence_pair_to_rnn_dataset(self, s1_list, s2_list, label_list=None):
        ...
        if label_list:  # train
            ...
            return TensorDataset(
                ...
                all_label_ids)
        # test
        return TensorDataset(all_s1_ids, all_s2_ids, all_s1_lengths, all_s2_lengths)
...
def test_data():
    ...
    # For BERT model
    data = Data('model/bert/vocab.txt', model_type='bert')
    _, _, _ = data.load_train_and_valid_files('/raid/bruce/cail_nlp/SMP-CAIL2020-Argmine-train/SMP-CAIL2020-train.csv', 
    '/raid/bruce/cail_nlp/SMP-CAIL2020-Argmine-train/SMP-CAIL2020-test1.csv')
    # For RNN model
    # data = Data('model/rnn/vocab.txt', model_type='rnn')
    # _, _, _ = data.load_train_and_valid_files('SMP-CAIL2020-train.csv', 'SMP-CAIL2020-test1.csv')
