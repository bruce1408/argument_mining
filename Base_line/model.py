...
class BertForClassification(nn.Module):
    ...
    def forward(self, input_ids, attention_mask, token_type_ids):
        ...
        Args:
            ...
            token_type_ids: (batch_size, max_seq_len) is same to segment embedding

        Returns:
        last_hidden_state[batch_size, max_seq_len, hidden_size]

            logits: (batch_size, num_classes)
        """
        # input_ids [batch_size, 512], pass through into bert [batch_size, max_seq_len, hidden_size] 
        ...
        # bert_output[0]: (batch_size, sequence_length, hidden_size) [batch_size, 512, 768]
...
class RnnForSentencePairClassification(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.rnn = nn.GRU(config.hidden_size, hidden_size=config.hidden_size,
